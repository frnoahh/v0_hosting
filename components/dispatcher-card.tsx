  ...
  return (
    <Card className="overflow-hidden border-primary/20 hover:border-primary transition-colors hover:shadow-primary-glow">
      <div
        ...
        style={{
          backgroundImage:
            "https://cdn.discordapp.com/attachments/1395643075656683602/1395654882500808736/BRCC_Website_Banner.png?ex=689794a6&is=68964326&hm=ecc295ee95897bd02c85dcdf2f7589b1afc1b0a67f6b36f19191ab4e88848c2b&')",
        }}
      />
